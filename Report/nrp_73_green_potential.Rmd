...
*June 2020*, by <a href="https://cieb.unibas.ch/de/test/" target = "_blank">Matthias Niggli</a> and <a href="https://cieb.unibas.ch/de/test/" target = "_blank">Christian Rutzer</a>
...
renderText({
    ...
    unique(dat[which(min(dat$share_green, na.rm = T)==dat$share_green), "region"]),
    ifelse(round(unique(dat[which(min(dat$share_green, na.rm = T)==dat$share_green),"share_green"])*100,0)==0, 
           paste0(" with nearly zero percent."), paste0(" with a share of ",
                                                        round(unique(dat[which(min(dat$share_green, na.rm = T)==dat$share_green),
                                                                         "share_green"])*100, 0), "%.")
           )
    )
})
