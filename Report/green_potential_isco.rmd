...
#### <font color="green"> The green potential of occupations, countries and the Swiss Economy </font>
...
renderPlotly({
        ggplotly(
                ...
                scale_color_viridis(option="viridis", begin = 0.8, end = 0.2, discrete = FALSE, name = "None")+
                guides(color = FALSE)+
